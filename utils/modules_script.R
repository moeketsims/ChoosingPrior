    ...
    sidebarLayout(
      ...
      mainPanel(width = 10,
        ...
        column(7,
               ...
               (e.g. completed a task denoted by 1 and not completed by 0). Thus, in BML we acknowledge that, we know something about the world we are modelling. 
               For example, before seeing the data, we may believe that students are likely to complete a qualification the are enrolled for and thus, this prior 
               belief can be quantified by a Beta(a,b) density plot on the left. This belief can be seen by choosing a value of  
               \\(a > b\\)
                  ')
