                 ...
                 fluidRow(
                   ...
                   column(6,
                          fluidRow(
                            boxPlus(
                              width = 12,
                              title = "What is your belief about Learning Designs before you see data", 
                              closable = FALSE, 
                              status = "primary", 
                              solidHeader = FALSE, 
                            ...
                            boxPlus(
                              width = 12,
                              title = "What is the data saying about Learning Design 1", 
                              closable = FALSE, 
                              status = "primary", 
                              solidHeader = FALSE, 
                              collapsible = FALSE,
                   ...
                   column(6,
                          fluidRow(
                            ...
                            boxPlus(
                              width = 12,
                              title = "What is the data saying about Learning Design 2?", 
                              closable = FALSE, 
                              status = "primary", 
                              solidHeader = FALSE, 
                              collapsible = FALSE,
